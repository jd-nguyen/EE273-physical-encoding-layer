...
HD_PWD='E:/Vivado Projects/pcs/pcs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcs_1000base_t_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcs_1000base_t_top.tcl
